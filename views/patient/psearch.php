...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../assets/css/psearch_style.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-ui-timepicker-addon/1.6.3/jquery-ui-timepicker-addon.min.css" />
  <title>Search | P R M S</title>
</head>
...
<body>
  ...
  <body>
    ...
    <div class="form-box">
      <div class="form">
        <form class="search-form" action="/patient/search" method="post">
    ...
    if (isset($_POST["search-submit"])) {
      ...
      if (!empty($_POST["ref"])) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          header("Location: /patient/search?error=sqlerror1");
        } else {
        ...
        if (empty($_POST["did"]) || empty($_POST["date"]) || empty($_POST["time"])) { {
          ...
          $stmt = mysqli_stmt_init($conn);
          if (!mysqli_stmt_prepare($stmt, $sql)) {
            header("Location: /patient/search?error=sqlerror");
          } else {
      ...
      if (!empty($_POST["ref"])) {
        ...
        $stmt = mysqli_stmt_init($conn);
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          header("Location: /patient/search?error=sqlerror2");
        } else {
          mysqli_stmt_bind_param($stmt, "ss", $uid, $rfr);
          mysqli_stmt_execute($stmt);
          $result = mysqli_stmt_get_result($stmt);
      ...
      if (!empty($_POST["ref"])) {
        ...
        $stmt = mysqli_stmt_init($conn);
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          header("Location: /patient/search?error=sqlerror3");
        } else {
          mysqli_stmt_bind_param($stmt, "ss", $uid, $rfr);
          mysqli_stmt_execute($stmt);
          $result = mysqli_stmt_get_result($stmt);
      ...
      if (!empty($_POST["ref"])) {
        ...
        $stmt = mysqli_stmt_init($conn);
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          header("Location: /patient/search?error=sqlerror4");
        } else {
          mysqli_stmt_bind_param($stmt, "ss", $uid, $rfr);
          mysqli_stmt_execute($stmt);
          $result = mysqli_stmt_get_result($stmt);
